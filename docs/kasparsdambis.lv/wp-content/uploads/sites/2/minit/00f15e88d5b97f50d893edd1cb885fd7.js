...
(()=>{"use strict";const e={n:r=>{const n=r&&r.__esModule?()=>r.default:()=>r;return e.d(n,{a:n}),n},d:(r,n)=>{for(var t in n)e.o(n,t)&&!e.o(r,t)&&Object.defineProperty(r,t,{enumerable:!0,get:n[t]})},o:(e,r)=>Object.hasOwn(e,r)},r=window.wp.domReady;var n=e.n(r);const t=window.wp.apiFetch;var o=e.n(t);const a=window.wp.url;n()(()=>{const e={onclickHrefPatterns:["amazon."]},r={urls:{}};function n(e){const n=(0,a.addQueryArgs)("/dambis-kit/v1/aff-url",{url:e});return r.urls[e]||(r.urls[e]=o()({path:n}).then(e=>e.url).catch(()=>e)),r.urls[e]}function t(e){const r=e.currentTarget;e.preventDefault(),n(r.href).then(e=>{"_blank"===r.target?window.open(e,"_blank","noopener,noreferrer"):window.location.assign(e)})}document.querySelectorAll("a[href]").forEach(r=>{e.onclickHrefPatterns.some(e=>r.href.includes(e))&&(r.addEventListener("mouseenter",e=>{n(e.currentTarget.href)}),r.addEventListener("focus",e=>{n(e.currentTarget.href)},!0),r.addEventListener("touchstart",e=>{n(e.currentTarget.href)},{passive:!0}),r.addEventListener("click",t))})})})();